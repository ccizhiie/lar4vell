...
class AbsensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $latitudekantor = -8.132982; // Latitude kantor
        $longitudekantor = 112.56397; // Longitude kantor
        ...
        if ($radius > 50000) {
            echo "error|Anda berada diluar jangkauan, jarak anda " . $radius . " meter dari kantor|";
        } else {
            if ($cek > 0) {
    ...
    function distance($lat1, $lon1, $lat2, $lon2)
    {
        ...
        $miles = acos($miles);
        $miles = rad2deg($miles);
        $miles = $miles * 60 * 1.1515; // Miles to kilometers conversion
        $kilometers = $miles * 1.609344; // Miles to kilometers
        $meters = $kilometers * 1000; // Kilometers to meters
